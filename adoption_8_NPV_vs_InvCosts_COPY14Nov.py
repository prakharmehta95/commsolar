# -*- coding: utf-8 -*-
"""
Created on Thu Nov 14 16:38:54 2019
...
#ABM Packages
from mesa import Agent, Model #base classes in the mes librart
...
if scenario == "ZEV" or scenario == "no_ZEV":
    ...
    #NPV information
    """THIS AGAIN COMES FROM THE NPV CALCULATION OF THE AGENTS"""
    ...
    """THIS NEEDS TO BE CALCULATED WITHIN THE ABM STAGE 2"""
    ...
    #INFORMATION on agents and all combinations
    agents_info = pd.read_excel (r'C:\Users\iA\OneDrive - ETHZ\Thesis\PM\Data_Prep_ABM\Skeleton_Updated_No_100MWh_Restriction.xlsx')#test_agents_skeleton.xlsx') #for an earlier version of Excel, you may need to use the file extension of 'xls'
...
# =============================================================================
# AGENT INFORMATION
list_agents = list(agents_info.loc[:,'bldg_id'])

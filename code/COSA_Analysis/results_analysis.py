...
for key, val in out_dict.items():
    for input_file in glob.glob(join(data_dir,'*'+key+'.feather')):
        ...
        label = "_".join(input_file.split("_")[5:])
...
# Temporary fix
model_df["com_year"].loc["no_com_no_dm"] = 2050
model_df["com_year"].loc["com_2019_dm_100"] = 2019
model_df["com_year"].loc["com_2019_no_dm"] = 2019

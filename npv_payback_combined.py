# -*- coding: utf-8 -*-
"""
Created on Wed Nov 13 19:31:13 2019
...
for FileList in ['Z0003']:#agent_list_final:
    print(FileList)
...
for FileList in ['Z0003']:#agent_list_final:
    print(FileList)
    path_dem = r"C:\Users\iA\OneDrive - ETHZ\Thesis\PM\CEA Data\Sample 1650\outputs\data\demand\\"
...
Agents_Savings = pd.DataFrame(data = None, index = ['Z0003'])
Agents_OM_Costs = pd.DataFrame(data = None, index = ['Z0003'])
Agents_EWZ_Costs= pd.DataFrame(data = None, index = ['Z0003'])
Agents_NetSavings = pd.DataFrame(data = None, index = ['Z0003'])
Agents_SCRs =  pd.DataFrame(data = None, index =['Z0003'])
...
for year in range(PV_lifetime):
    ...
    for i in ['Z0003']:#agent_list_final:
...
for year in range(PV_lifetime):
    ...
    list_scrs = []
    print(year)
    for i in ['Z0003']:#agent_list_final:#['Z0003','Z0004']:
        #print(i)
...
temp_savings_df['Bldg_IDs'] = ['Z0003']#agent_list_final
temp_savings_df = temp_savings_df.set_index('Bldg_IDs')              

for i in ['Z0003']:#agent_list_final:#['Z0003','Z0004']: #put agent_list_final here later
    inv_cost_list = []
    temp_npv_list = []
    temp_payback_list = []
...
# =============================================================================
        ...
        #savings_temp = [x * -10 for x in savings_temp]

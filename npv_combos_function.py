...
def npv_calc_combos(df_solar_AC, df_demand, year_model, agent_enchamp_type, df_pv_size, df_num_smartmeters, df_num_members, admin_costs, rate_cooperation, temp_names_comms_list):
...
# =============================================================================
#     #temporary, delte later
#     agent_list_final = ['B147890','B147891','B147893','B140995']#df_solar_AC.columns
#     print(agent_list_final)
#     
# =============================================================================
...
# =============================================================================
#     #temporary - delter later
#     agent_enchamp_type = 'Homeowner'
#     
# =============================================================================
    ...
    ctr = 0
    days = ['Sat','Sun','Mon','Tue','Wed','Thu',' Fri'] #this order because 2005 started with a Saturday - very crude way to code, I did it before so I don't change it
    list_days = []
    df_demand['Day'] = ""
    df_solar_AC['Day'] = ""
    for i in range(365):
    ...
    for i in agent_list_final:
        ...
        print(i)
        install_year = 5
        #for install_year in range(1): # 0 = 2018, 17 = 2035 '''NEED TO FIND OUT WHICH YEAR WE ARE IN!'''
        #print(i)
        temp_pv_size =   df_pv_size.loc['Size'][i]
        temp_num_meters = df_num_smartmeters.loc['Num'][i]
        
        if temp_pv_size < 30:
            temp_pv_subsidy =  1600 + 460*temp_pv_size#agents_info.loc[i]['pv_subsidy'] #'''NEED TO CALCULATE THIS VALUE HERE'''
        elif 30 <= temp_pv_size < 100:
            temp_pv_subsidy =  1600 + 340*temp_pv_size#agents_info.loc[i]['pv_subsidy'] #'''NEED TO CALCULATE THIS VALUE HERE'''
        elif temp_pv_size >= 100:
            temp_pv_subsidy =  1400 + 300*temp_pv_size#agents_info.loc[i]['pv_subsidy'] #'''NEED TO CALCULATE THIS VALUE HERE'''
        ...
        #cooperation is okay for a new community formation bu thow do I do this for an existing community and someone joining it?
        ...
        print('temp_npv_list === ', temp_npv_list)
# =============================================================================
...
# =============================================================================
    ...
    #end of a building
        #print(len(temp_npv_list))
        #print(len(Agents_NPVs.index))
        #print("i = ", i )
    #Agents_NPVs[i] = ""
